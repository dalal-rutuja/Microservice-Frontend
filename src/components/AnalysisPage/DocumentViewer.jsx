...
const DocumentViewer = ({
  ...
  return (
    <div className="flex flex-col h-full space-y-3">
      ...
      {/* Response Content */}
      <div
        className="flex-1 min-h-0 overflow-y-auto px-2 sm:px-4 pb-2 sm:pb-4 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full"
