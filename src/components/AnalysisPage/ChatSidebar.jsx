...
// import {
//   Search, FileText, Loader2, ChevronRight, MessageSquare
// } from 'lucide-react';
                        ...
                        <div className="relative w-8 h-8">
                          <svg className="w-8 h-8 transform -rotate-90">
                            ...
                            <circle
                              ...
                              strokeDashoffset={`${2 * Math.PI * 14 * (1 - (doc.progress || 0) / 100)}`}
                              className="text-blue-600 transition-all duration-500"
                            />
                          </svg>
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-xs font-semibold text-blue-600">{doc.progress || 0}%</span>
                          </div>
                        </div>
