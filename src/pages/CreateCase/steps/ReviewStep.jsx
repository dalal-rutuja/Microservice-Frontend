...
// import { CheckCircle, FolderOpen, Upload, Calendar, Sparkles } from 'lucide-react';
...
//         <h2 className="text-2xl font-bold text-gray-900 mb-3">Case Created Successfully!</h2>
//         <p className="text-sm text-gray-600 mb-2">
//           Your case has been created and saved to your dashboard. <strong>{caseNumber}</strong>
//         </p>
...
//             <p className="text-xs text-gray-500">Key details for your newly created case</p>
//           </div>
//         </div>
...
//                 {caseData.caseTitle || 'Raj Kumar Singh vs State'}
//               </p>
//             </div>
//             <div>
...
//         <button className="flex-1 px-4 py-3 bg-[#9CDFE1] text-white rounded-md hover:bg-[#87D8DB] transition-colors flex items-center justify-center text-sm font-medium">
