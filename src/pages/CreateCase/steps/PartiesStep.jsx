...
//               ? 'border-b-2 border-[#21C1B6] text-[#21C1B6]'
//               : 'text-gray-500'
//           }`}
//         >
...
//                 <h4 className="font-semibold">Petitioner {index + 1}</h4>
//                 {index > 0 && (
//                   <button
...
//                     className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#21C1B6]"
//                   />
//                 </div>
...
//                 <div className="grid grid-cols-2 gap-4">
//                   <div>
//                     <label className="block text-sm font-medium text-gray-700 mb-1">Bar Registration No.</label>
//                     <input
//                       type="text"
//                       placeholder="Enter bar registration number"
//                       value={petitioner.barRegistration}
//                       onChange={(e) => updatePetitioner(index, 'barRegistration', e.target.value)}
//                       className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#21C1B6]"
//                     />
//                   </div>
...
//             className="w-full py-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-[#21C1B6] hover:text-[#21C1B6]"
//           >
...
//             <div key={index} className="bg-gray-50 p-6 rounded-lg">
//               <div className="flex justify-between items-center mb-4">
//                 <h4 className="font-semibold">Respondent {index + 1}</h4>
//                 {index > 0 && (
//                   <button
...
//                       onChange={(e) => updateRespondent(index, 'advocateName', e.target.value)}
//                       className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#21C1B6]"
//                     />
//                   </div>
//                 </div>
...
//                       onChange={(e) => updateRespondent(index, 'barRegistration', e.target.value)}
//                       className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#21C1B6]"
//                     />
//                   </div>
